...
description: Autonomous indoor navigation system for the AgileX LIMO robot using ROS1 Melodic, RTAB-Map SLAM, and a custom multi-stage recovery behavior for reliable path planning in tight spaces.
