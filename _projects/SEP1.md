...
🔗 [View Full Code on GitHub →](https://github.com/YongJiee/Systems-Engineering-Project-1-Group-6.git)
...
- Constructed a Changi Airport-themed test arena with 35cm-wide paths and 10cm ramp
- Implemented dynamic recovery logic using `/move_base/make_plan` service
